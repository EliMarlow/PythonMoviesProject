...
var Document_1 = __importDefault(require("@dashevo/dpp/lib/document/Document"));
/**
 * Prefetch contract
 *
        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    ...
                    if (opts.startAt instanceof Document_1.default) {
                        opts.startAt = opts.startAt.getId();
                    }
                    else if (typeof opts.startAt === 'string') {
                        opts.startAt = Identifier_1.default.from(opts.startAt);
                    }
                    if (opts.startAfter instanceof Document_1.default) {
                        opts.startAfter = opts.startAfter.getId();
                    }
                    else if (typeof opts.startAfter === 'string') {
                        opts.startAfter = Identifier_1.default.from(opts.startAfter);
                    }
