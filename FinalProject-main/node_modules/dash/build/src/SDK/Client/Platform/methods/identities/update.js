...
function update(identity, publicKeys, privateKeys) {
    return __awaiter(this, void 0, void 0, function () {
        var dpp, identityUpdateTransition, signerKeyIndex, signerKey_1, starterPromise, result;
        var _this = this;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, identityUpdateTransition.signByPrivateKey(privateKey, publicKey.getType())];
                                    case 1:
                                        _a.sent();
