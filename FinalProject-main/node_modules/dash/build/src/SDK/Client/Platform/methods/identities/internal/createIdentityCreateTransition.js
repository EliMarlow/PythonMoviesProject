...
function createIdentityCreateTransition(assetLockProof, assetLockPrivateKey) {
    return __awaiter(this, void 0, void 0, function () {
        var platform, account, dpp, identityIndex, identityMasterPrivateKey, identityMasterPublicKey, identitySecondPrivateKey, identitySecondPublicKey, identity, identityCreateTransition, _a, masterKey, secondKey, result;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3:
                    ...
                    identityMasterPrivateKey = account.identities.getIdentityHDKeyByIndex(identityIndex, 0).privateKey;
                    identityMasterPublicKey = identityMasterPrivateKey.toPublicKey();
                    identitySecondPrivateKey = account.identities.getIdentityHDKeyByIndex(identityIndex, 1).privateKey;
                    identitySecondPublicKey = identitySecondPrivateKey.toPublicKey();
                    identity = dpp.identity.create(assetLockProof, [{
                    ...
                    return [4 /*yield*/, identityCreateTransition.signByPrivateKey(identityMasterPrivateKey, IdentityPublicKey_1.default.TYPES.ECDSA_SECP256K1)];
                case 4:
                    _b.sent();
                    masterKey.setSignature(identityCreateTransition.getSignature());
                    identityCreateTransition.setSignature(undefined);
                    return [4 /*yield*/, identityCreateTransition.signByPrivateKey(identitySecondPrivateKey, IdentityPublicKey_1.default.TYPES.ECDSA_SECP256K1)];
                case 5:
                    _b.sent();
                    secondKey.setSignature(identityCreateTransition.getSignature());
                    identityCreateTransition.setSignature(undefined);
                    // Sign and validate state transition
                    return [4 /*yield*/, identityCreateTransition.signByPrivateKey(assetLockPrivateKey, IdentityPublicKey_1.default.TYPES.ECDSA_SECP256K1)];
                case 6:
                    // Sign and validate state transition
                    _b.sent();
