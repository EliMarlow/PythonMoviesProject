        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    _b.sent();
                    dpp = this.dpp;
                    return [4 /*yield*/, this.dpp.dataContract.createFromObject(dataContract.toObject())];
                case 2:
                    updatedDataContract = _b.sent();
                    updatedDataContract.incrementVersion();
                    dataContractUpdateTransition = dpp.dataContract.createDataContractUpdateTransition(updatedDataContract);
