...
describe('API', () => {
    it('should return none if data is same', () => {
        ...
        const obj = validator_1.validateSchemaFiles(file1, file2);
    ...
    it('should throw error on remove', () => {
        ...
        assert.throws(() => {
            validator_1.validateSchemaFiles(file1, file2);
        }, Error);
    });
    ...
    it('should return none if field is added and it\'s not required', () => {
        ...
        assert.doesNotThrow(() => validator_1.validateSchemaCompatibility(originalSchema, newSchema));
    });
    it('should throw if field becomes required', () => {
        ...
        const newSchema = fast_json_patch_1.deepClone(originalSchema);
        newSchema.required = ['/'];
        assert.throws(() => validator_1.validateSchemaCompatibility(newSchema, originalSchema));
    });
